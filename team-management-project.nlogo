...
to color-patch
  ;; set the color based on the amount of potential work available
  set pcolor (yellow + 4.9 - pwork)
end

to add-work-to-patch
  ;; TODO: randomly change max after an agent grabs the work from the patch
  set pwork min (list max-pwork (pwork + 1))
end
@#$#@#$#@
GRAPHICS-WINDOW
210
